        ...
        {activeTab === 'revendedores' && isAdmin && (
          <div className="bg-[#111827] border border-amber-500/30 rounded-2xl p-6 shadow-xl space-y-6">
            ...
            <div className="flex gap-2 bg-[#1f2937]/40 p-4 rounded-xl border border-gray-800">
              <input type="text" placeholder="Digite o ID ou e-mail para adicionar manualmente..." value={newResellerEmail} onChange={(e) => setNewResellerEmail(e.target.value)} className="flex-1 px-4 py-2 bg-[#1f2937] border border-gray-700 rounded-xl text-white text-sm" />
